...
node --check server.js && node --check ai-provider.js && node --check agent-runtime.js && node --check assistente.js && node --check agent-review.js && node --check intelligence-orchestrator.js && node --check intelligence-feedback.js && node --check document-intake.js && node --check document-service.js && node --check extract.js && node --check painel.js && node --check os-core.js && node --check agent-tools.js && node --check os-app.js && node --check oportunidades.js && node --check varredura.js && node --check mercado-aquecer.js && node --check ingerir.js && node --check reextrair-falhas.js && node --check areas-predios.js && node --check busca-web.js && node --check links-prefeitura.js
