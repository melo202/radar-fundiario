...
test("caixa-goiania.js: parseia (window.CAIXA), 164 imóveis, x/y presente-ou-null COERENTE (nunca só uma das coordenadas)", () => {
  ...
  assert.equal(CAIXA.imoveis.length, 164, "contagem de imóveis divergiu do snapshot auditado (atualizado em 2026-08-25; a lista da CAIXA muda conforme vendem/abrem edital — ao atualizar o dataset, atualize este pino)");
